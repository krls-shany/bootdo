			...
			.bootstrapTable(
					{
						...
						// showToggle : true,	// 设置true为显示切换按钮以切换表/卡视图
						showColumns : true,
						iconSize : 'outline',
						...
						// "server",使用'server'则side需要设置'url'或'ajax'选项
...
function preview(id) {
	window.open("/blog/open/post/"+id);   			// 转跳到新的标签页
	//window.location.href="/blog/open/post/"+id;	   当前页面转跳
}
