! function (t) {
        ...
        ! function () {
            ...
            It._$ni = function (t, i, e, r, o, n, s, _, a) {
                ...
                if (a <= 0) {
                    ...
                    for (var A = o[h[0]], I = o[h[1]], w = o[h[2]], O = o[h[3]], D = o[h[4]], R = o[h[5]], b = o[h[6]], F = o[h[7]], g = l[0], P = l[1], C = l[2], y = 1 - g, S = 1 - P, N = 1 - C, B = N * S * y, U = N * S * g, G = N * P * y, Y = N * P * g, k = C * S * y, V = C * S * g, X = C * P * y, z = C * P * g, c = 0; c < $;) n[u] = B * A[c] + U * I[c] + G * w[c] + Y * O[c] + k * D[c] + V * R[c] + X * b[c] + z * F[c], ++c, n[u + 1] = B * A[c] + U * I[c] + G * w[c] + Y * O[c] + k * D[c] + V * R[c] + X * b[c] + z * F[c], ++c, u += _;
                else if (4 == a)
                    ...
                    for (var Et = 1 << a, At = new Float32Array(Et), It = 0; It < Et; It++) {
                        for (var xt = It, wt = 1, Ot = 0; Ot < a; Ot++) wt *= xt % 2 == 0 ? 1 - l[Ot] : l[Ot], xt /= 2;
                        At[It] = wt
                    }
    ...
    o.prototype = new n.L2DBaseModel, o.prototype.load = function (t, i, e) {
        //extend by shany 2019-01-21 start
        if(typeof i != 'string')
            i=JSON.stringify(i);
        console.log("i=["+i+"]");
        //extend by shany 2019-01-21 end
